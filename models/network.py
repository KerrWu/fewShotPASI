...
class meta_model():
    def __init__(self, image_size=(224, 224), backbone_name="resnet50", training=True):
        ...
        self.conv2d_1 = K.layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same", activation='relu',
                                        kernel_initializer='he_normal', bias_initializer='zeros')

        self.conv2d_2 = K.layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same", activation='relu',
                                        kernel_initializer='he_normal', bias_initializer='zeros')

        self.conv2d_3 = K.layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same", activation='relu',
                                        kernel_initializer='he_normal', bias_initializer='zeros')
